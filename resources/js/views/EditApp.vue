...
export default {
    ...
    methods: {
        submit(){
            this.errors = {};
            axios.post(`http://sudeepmishra.com.np/api/saveApp/${this.$route.params.app_id}`,this.fields)
            .then(response => {
    ...
    created() {
        ...
        axios.get(`http://sudeepmishra.com.np/api/getApp/${this.$route.params.app_id}`)
        .then(app => {
            this.fields = app.data;
        })
    },
